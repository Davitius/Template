...
class EboutController extends Controller
{
    public function index($language)
    {
        ...
        $Ebout = DB::table('posts')->where('type', 'Ebout')->get();


        return view('Ebout.ebout', compact('language', 'background', 'menu', 'block1', 'block2',
            'block3', 'block4', 'block5', 'block6', 'usefullinks', 'usefullinks2', 'header', 'sliders', 'footerWords',
            'socialIcons', 'ULImages', 'ULImages2', 'Blocks', 'Ebout'));
    }
}
