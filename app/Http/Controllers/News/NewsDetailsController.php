...
//        dd($language);
        ...
        return view('News.news_details', compact('language', 'background', 'menu', 'block1', 'block2',
            'block3', 'block4', 'block5', 'block6', 'usefullinks', 'usefullinks2', 'header', 'sliders',
            'footerWords', 'socialIcons', 'ULImages', 'ULImages2', 'new', 'Blocks'));
    }
}
